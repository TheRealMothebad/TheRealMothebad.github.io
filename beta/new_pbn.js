...
function onPointerUp(e)
{
  console.log("up")
    ...
    create_persistant_text("Wow", (getEventLocation(e).x - cameraOffset.x)/Math.sqrt(cameraZoom),
      (getEventLocation(e).y - cameraOffset.y)/Math.sqrt(cameraZoom), 32, "courier")
  }
}
